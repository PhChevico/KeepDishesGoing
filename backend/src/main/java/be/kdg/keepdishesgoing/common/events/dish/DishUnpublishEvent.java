...
public record DishUnpublishEvent(
    ...
    public DishUnpublishEvent(UUID dishId, String name, String typeOfDish, List<String> foodTags, String description, BigDecimal price, String picture, String dishStatus, UUID foodMenuId, UUID restaurantId) {
